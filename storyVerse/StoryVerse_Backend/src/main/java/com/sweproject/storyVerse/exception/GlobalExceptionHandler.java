...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAdminCreationException(AdminCreationException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleAuthorDeletionException(AuthorDeletionException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    public ResponseEntity<ErrorResponse> handleAuthorUpdateException(AuthorUpdateException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    // Özel BranchPostException için handler
    @ExceptionHandler(BranchPostException.class)
    public ResponseEntity<ErrorResponse> handleBranchPostException(BranchPostException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    @ExceptionHandler(ContributorCreationException.class)
    public ResponseEntity<ErrorResponse> handleContributorCreationException(ContributorCreationException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    @ExceptionHandler(GenrePostException.class)
    public ResponseEntity<ErrorResponse> handleGenrePostException(GenrePostException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    @ExceptionHandler(StoryDescriptionNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleStoryDescriptionNotFoundException(StoryDescriptionNotFoundException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
